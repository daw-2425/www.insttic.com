...
include './bbb/db.php'; // Asegúrate de que este archivo contenga la conexión a la base de datos
...
<head>
    ...
    <link rel="stylesheet" href="./bbb/css/all.css">
    <link rel="stylesheet" href="./bbb/css/bootstrap.css">
    <link rel="stylesheet" href="./bbb/css/estilos.css">
    <link rel="stylesheet" href="./bbb/est.css">
</head>
<body>
...
<div class="general conteiner-fluid d-flex">
    ...
    <div class="aside d-none d-lg-block">
        ...
        <li><a href="">
        <li><a href="./index.php"><i class="fa-solid fa-user-graduate"></i> <span> Permisos</span> </a></li>
                <li><a href="./salidas.php"><i class="fa-solid fa-person-walking-arrow-right"></i></i> <span>Puerta</span> </a></li>
               <li><a href=""><i class="fa-solid fa-user-graduate"></i> <span> Salidas</span> </a></li>
        </nav>
...
<script src="./bbb/js/aside.js"></script>
<script src="./bbb/js/all.js"></script>
<script src="./bbb/js/bootstrap.js"></script>
