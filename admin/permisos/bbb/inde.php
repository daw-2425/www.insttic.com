...
<div class="general conteiner-fluid d-flex">
    ...
    <div class="lupa">
        ...
        <div class="container mt-5">
            <button type="button" class="btn btn-secondary bajar" data-bs-toggle="modal" data-bs-target="#studentModal">
                Agregar
            </button>
        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="studentModalLabel">Formulario de Estudiante</h5>
                    </div>
                    <div class="modal-body">
                        <form method="POST" action="">
                            ...
                            <div class="form-group">
                                <label for="numero_cuarto">Número de Cuarto:</label>
                                <input type="number" class="form-control" id="numero_cuarto" name="numero_cuarto" required>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="modal-footer">
                        <button type="submit" form="studentForm" class="btn btn-danger todo">Cerrar</button>
                    </div>
                </div>
            </div>
        </div>
 ...
 <div class='caja'>
    <div class="container">
        <h2 class="mt-5"><i class="fa-solid fa-person-walking-arrow-right"></i> Lista de Salidas</h2>
