...
<div class="general conteiner-fluid d-flex">
    ...
    <div class="aside d-none d-lg-block">
        ...
        <nav class="nav">
                ...
                <li><a href="./regis.php" class='billy'><i class="fa-solid fa-door-closed"></i> <span>Salidas</span> </a></li>
                <li><a href="../index.php"><i class="fa-solid fa-person-walking-arrow-right"></i> <span>Permisos</span> </a></li>
                <li><a href=""></a></li>
                <li><a href=""></a></li>
                <li><a href=""></a></li>
                <li><a href=""></a></li>
    ...
    <tbody>
        <?php foreach ($permisos as $permiso): ?>
            <tr>
                ...
                <td><div class="texto-con-puntos"><?= $permiso['motivo'] ?></div></td>
                ...
                <td>
                    ...
                    <?php else: ?>
                        ...
                        if (strtotime($permiso['fecha_salida']) < time() && $permiso['estado'] !== 'regresado'): ?>
                            <span class="badge badge-warning">tarde</span> <!-- Insignia -->
                        <?php endif; ?>
