...
<div class="general conteiner-fluid d-flex">
    ...
    <div class="aside d-none d-lg-block">
        ...
        <nav class="nav">
                ...
                <li><a href="../php/asir.php"><i class="fa-solid fa-user-graduate"></i> <span> TS-ASIR</span> </a></li>
  ...
  <ul class="dropdown-menu dropdown-menu-dark">
    <li><a class="dropdown-item active" href="#">2017-2020</a></li>
    <li><a class="dropdown-item" href="#">2020-2023</a></li>
    <li><a class="dropdown-item" href="#">2023-2025</a></li>
           ...
           <table class="table orde">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><span class="status completed">222 653456</span></td>
                  <td>
                  <a href="../php/actualizar.php" class="btn btn-outline-info" id="actualizar"><i class="fa-regular fa-pen-to-square"></i></i></a>
                    <a href="../php/vistaRegistro.php" class="btn btn-outline-success" ><i class="fa-solid fa-eye"></i></a>
                    <button class="btn btn-outline-danger"><i class="fa-regular fa-trash-can"></i></button>
                  </td>
                </tr>
