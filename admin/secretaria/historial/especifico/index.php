...
<section id="notasHa" class="mt-5">
            ...
            <article id="cajaha">
                ...
                <div class="" id="icon2">
                    <article class="text-bg-dark" id="mateha">
                        <label for="">Media General 2023/2024</label>
                    </article>
                    <article id="mateha1">
                        <label for="">8</label>
                    </article>
    ...
    <section class="d-flex justify-content-end me-5">
        ...
        <!-- <select name="" id="sele" class="mb-2">

            <option value="2024/2025">
                <a href="#">2024/2025</a>
            </option>
            <option value="2023">
            <a href="./anio1/anio1.php">2023</a>
            </option>
            <option value="2024">
                <a href="./anio2/anio2.php">2024</a>
            </option>
        </select> -->
...
<div class="btn-group">
  <a href="#" class="text-decoration-none text-black"><i class="fa-solid fa-table"></i> <span>2024/2025</span> </a>
  ...
  <ul class="dropdown-menu">
    ...
    <section class="d-flex container col-11 align-items-center justify-content-center" id="tabla-sect">
        ...
        <!-- <div class="porcentaje col-2 mx-1" id="valua"> -->
        <!-- <section  id="por" class="bg-white circ">
                
                <div id="porc"  ></div>

            </section>
            <section class="text-bg-dark d-flex align-items-center justify-content-center" id="aviso">
                <h3 class="">RESUMEN GENERAL EN TANTO POR CIENTO DEL ESTUDIANTE </h3>
...
<script src="./js/aside-especifico.js" ></script>
