...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        if ($accion === 'crear') {
            ...
            $stmtAlumno->bindParam(':correo', $_POST['correo']);
            ...
            $sql = $conexion->prepare("INSERT INTO usuario (correo, passwd, id_alumno) VALUES ('$correo', '$contraseña_encriptada', '$id_alumno_nuevo');");
...
';
            ...
            // Confirmamos la transacción
            $conexion->commit();
            $mensaje .= " y cuenta de usuario creada correctamente";
        }
