  ...
  <div class="general conteiner-fluid d-flex">
    ...
    <div class="aside d-none d-lg-block">
      ...
      <nav class="nav">
        ...
        <li><a href="../php/todasActas.php"><i class="fa-solid fa-user-graduate"></i> <span> Actas</span> </a></li>
        <!--<a href=""><i class="fa-solid fa-user-graduate"></i> <span> enlace</span> </a></li>
    ...
    <div class="main">
      ...
      <main>
        ...
        <div class="head-title">
          <div class="left">
            <div class="dropdown ">
              <button class="btn btn dropdown-toggle especialidades" type="button" data-bs-toggle="dropdown"
                aria-expanded="false">
                Generacion
              </button>
              <ul class="dropdown-menu dropdown-menu-dark">
                <li><a class="dropdown-item active" href="../php/genracionAno.php">2023-2025</a></li>
...
-->
          ...
          <a href="../funciones/reportessmir.php" class="btn btn-dowload">
        ...
        <h2 class="listas">Acta de notas de TS-SMIR</h2>
        <div class="orde">
          <div class="head">
  ...
  <script src="../js/actasSMIR.js"></script>
