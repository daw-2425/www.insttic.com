          ...
          <div class="left">
            <div class="dropdown ">
              ...
              <ul class="dropdown-menu dropdown-menu-dark">
                <li><a class="dropdown-item active" href="../php/generacionasir.php">2023-2025</a></li>
...
-->
          ...
          <a href="../funciones/reportesasir.php" class="btn btn-dowload">
        ...
        <h2 class="listas">Acta de notas de TS-ASIR</h2>
        <div class="orde">
          <div class="head">
  ...
  <script src="../js/actasAsir.js"></script>
