          ...
          <div class="left">
            <div class="dropdown ">
              ...
              <ul class="dropdown-menu dropdown-menu-dark">
                <li><a class="dropdown-item active" href="../php/generaciondaw.php">2017-2020</a></li>
...
-->
          ...
          <a href="../funciones/reportes.php" class="btn btn-dowload">
        ...
        <h2 class="listas">Acta de notas de TS-DAWEB</h2>
        <div class="orde">
          <div class="head">
  ...
  <script src="../js/actasdaw.js"></script>
