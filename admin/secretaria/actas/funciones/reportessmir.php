...
ON m.id_especialidad = e.id_especialidad WHERE e.denominacion = 'TMSMIR'";
...
INNER JOIN especialidad e ON m.id_especialidad = e.id_especialidad WHERE e.denominacion = 'TMSMIR'";
...
$pdf->Output('I', 'reporte_notassmir.pdf');
?>