...
ON m.id_especialidad = e.id_especialidad WHERE e.denominacion = 'TSSTI'";
...
INNER JOIN especialidad e ON m.id_especialidad = e.id_especialidad WHERE e.denominacion = 'TSSTI'";
...
$pdf->Output('I', 'reporte_notasasti.pdf');
?>