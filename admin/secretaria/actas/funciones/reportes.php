...
$pdf->Cell(0, 10, 'ACTA DE NOTAS DE TSDWEB', 0, 1, 'C');
$pdf->Ln(10);
...
ON m.id_especialidad = e.id_especialidad WHERE e.denominacion = 'TSDAW'";
...
INNER JOIN especialidad e ON m.id_especialidad = e.id_especialidad WHERE e.denominacion = 'TSDAW'";
...
foreach ($alumnos as $alumno) {
    // Imprimir el nombre del alumno solo una vez, en la primera celda de la fila
...
$pdf->Output('I', 'reporte_notasweb.pdf');
?>