...
<head>
    ...
    <link rel="stylesheet" href="./css/desarrollo4.css">
                    ...
                    <div class="card mb-3 rounded-0" style="" id="card_texto_foto">
                        <div class="row g-0" id="row_card_texto_foto">
                            <div class="col-md" id="noticiagen_foto1">
                                <img src="./img/mar.webp" class="img-fluid " alt="..." id="img-fluid ">
                            </div>
                            <div class="col-md-7" id="noticiagen_foto1_texto">
                                <div class="card-body">
                                    <h4 class="card-title">La ciudad de Oyala organiza una maraton para los estudiantes por el 12 de octubre</h4>
                                    <p class="card-text">
